...
############################################################
open_project digital_setup_prj
...
open_solution "digital_setup_solution" -flow_target vivado
set_part {xc7z020-clg400-1}
create_clock -period 10 -name default
config_export -format ip_catalog -rtl verilog -vendor Francesco -version 1.0
source "./digital_setup_prj/digital_setup_solution/directives.tcl"
csim_design
csynth_design
cosim_design
export_design -format ip_catalog -vendor "Francesco"
