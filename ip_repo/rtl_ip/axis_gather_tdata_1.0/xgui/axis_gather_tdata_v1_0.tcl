...
proc update_PARAM_VALUE.BITS_COUNTER { PARAM_VALUE.BITS_COUNTER } {
	# Procedure called to update BITS_COUNTER when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.BITS_COUNTER { PARAM_VALUE.BITS_COUNTER } {
	# Procedure called to validate BITS_COUNTER
	return true
}
...
proc update_MODELPARAM_VALUE.BITS_COUNTER { MODELPARAM_VALUE.BITS_COUNTER PARAM_VALUE.BITS_COUNTER } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.BITS_COUNTER}] ${MODELPARAM_VALUE.BITS_COUNTER}
}
