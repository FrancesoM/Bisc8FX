...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = atan_saturation
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = atan_saturation_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_gather_tdata
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = axis_gather_tdata_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = digital_setup
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = digital_setup_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = pwm_scaling
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = pwm_scaling_0
END
